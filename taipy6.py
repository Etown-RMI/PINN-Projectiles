...
#issues still to tackle:
    #graph only displays if low epochs (executes quickly)
    #new graph wont overwrite old graph (should delete any existing output_plot on button click)
    #generating message should also be deleted when graph is shown
import numpy as np
